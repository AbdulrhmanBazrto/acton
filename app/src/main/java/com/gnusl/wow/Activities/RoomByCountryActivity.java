...
public class RoomByCountryActivity extends AppCompatActivity implements ConnectionDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_room_by_country);
    ...
    public static void show(Context context,String tag){
        ...
        Intent intent=new Intent(context,RoomByCountryActivity.class);
        intent.putExtra(RoomByCountryActivity.TAG_KEY,tag);
