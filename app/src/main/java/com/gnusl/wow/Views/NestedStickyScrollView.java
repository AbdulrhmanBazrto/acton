...
public class NestedStickyScrollView extends NestedScrollView {
    ...
    public NestedStickyScrollView(Context context, AttributeSet attrs) {
        ...
        scrollerTask = new Runnable() {
            ...
            public void run() {
                ...
                if (initialPosition - newPosition == 0) {//has stopped
                    ...
                    NestedStickyScrollView.this.postDelayed(scrollerTask, newCheck);
                }
            }
        };
    }

    public NestedStickyScrollView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void hideHeader() {
        if (currentlyStickingView != null) {
            currentlyStickingView.animate().alpha(1).setDuration(500).setListener(new Animator.AnimatorListener() {
                @Override
            ...
            Log.i("stickyScrollView", "hideHeader");
        }
    }
