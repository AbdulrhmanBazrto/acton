...
public class AutoFitFontedTextView extends AutofitTextView {

    public AutoFitFontedTextView(Context context) {
        this(context, null);
    }

    public AutoFitFontedTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public AutoFitFontedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
