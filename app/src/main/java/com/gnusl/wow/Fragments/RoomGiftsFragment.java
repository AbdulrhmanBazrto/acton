...
public class RoomGiftsFragment extends Fragment implements SmartTabLayout.TabProvider {

    private View inflatedView;
    private GiftsFragmentPagerAdapter giftsFragmentPagerAdapter;

    public RoomGiftsFragment() {
    }

    public static RoomGiftsFragment newInstance() {

        return new RoomGiftsFragment();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        inflatedView = inflater.inflate(R.layout.fragment_room_gifts, container, false);
