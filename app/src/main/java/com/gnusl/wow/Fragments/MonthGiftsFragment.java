...
public class MonthGiftsFragment extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public MonthGiftsFragment(Fragment parentFragment) {
        this.parentFragment=parentFragment;
    }

    public static MonthGiftsFragment newInstance(Fragment parentFragment) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        inflatedView = inflater.inflate(R.layout.fragment_month_gifts, container, false);
    ...
    private void refreshData(){
        ...
        if(parentFragment instanceof ReceivedGiftsFragment)
            refreshUsersData(giftsActivity.getMontReceivedhUserRanks());
        else if(parentFragment instanceof SentGiftsFragment)
            refreshUsersData(giftsActivity.getMontSenthUserRanks());
        else
            refreshRoomsData(giftsActivity.getMonthRoomRanks());
    }
