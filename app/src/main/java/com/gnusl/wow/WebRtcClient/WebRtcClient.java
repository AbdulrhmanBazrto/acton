...
public class WebRtcClient {
    ...
    private class MessageHandler {
        ...
        private Emitter.Listener getStream = new Emitter.Listener() {
            @Override
            public void call(Object... args) {
                //String id = (String) args[0];
                Log.d("Streams ",args.toString());
    ...
    public WebRtcClient(RtcListener listener, String host, PeerConnectionParameters params, EGLContext mEGLcontext,int channelId) {
        ...
        client.on("getStream", messageHandler.getStream);
        client.connect();
