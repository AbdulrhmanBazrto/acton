...
public class SwipeBackViewGroup extends ViewGroup {
    ...
    public SwipeBackViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        setOnTouchListener(new OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    //swipeLayoutLintier.hasChanged((int) offsetY);
    ...
    private void findScrollView(ViewGroup viewGroup) {
        ...
        if (viewGroup.getChildCount() > 0) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (child instanceof NestedScrollView || child instanceof AbsListView || child instanceof ScrollView || child instanceof ViewPager || child instanceof WebView) {
                    scrollChild = child;
                    return;
                }
            }
    ...
    private void smoothScrollToX(int finalLeft) {
        if (viewDragHelper.settleCapturedViewAt(finalLeft, 0)) {
            ViewCompat.postInvalidateOnAnimation(SwipeBackViewGroup.this);
        }
    }
